...
#if DEMO_AI
TaskHandle_t InferencePublishTask_Handle = NULL;
#endif
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(ExpressLink_WAKE_GPIO_Port, ExpressLink_WAKE_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, ExpressLink_RESET_Pin|LD2_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : ExpressLink_WAKE_Pin */
  GPIO_InitStruct.Pin = ExpressLink_WAKE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(ExpressLink_WAKE_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : ExpressLink_RESET_Pin LD2_Pin */
  GPIO_InitStruct.Pin = ExpressLink_RESET_Pin|LD2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
#if DEMO_AI
  xTaskCreate(vInferencePublishTask, "InferencePublishTask", configMINIMAL_STACK_SIZE * 4, (void*) 1, PRIORITY_InferencePublishTask, &InferencePublishTask_Handle);
#endif
