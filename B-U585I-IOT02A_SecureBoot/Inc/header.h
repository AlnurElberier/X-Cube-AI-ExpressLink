...
#define WEIGHTS_START_PAGE            (WEIGHTS_HEADER_START_ADDRESS / FLASH_PAGE_SIZE)
    ...
    #else
      #define MAX_HOTA_IMAGE_SIZE           ((FLASH_SIZE/2) - SECURE_BOOT_SIZE - FLASH_PAGE_SIZE - MAX_WEIGHTS_SIZE)
